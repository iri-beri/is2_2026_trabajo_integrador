...
| P3 | Planificación | OverEngineering (SobreIngeniería), utilización de tecnologías (lenguages,frameworks) que implican una arquitectura demasiado compleja con respecto al objetivo del sistema en el tiempo que se estima su entrega | Media | Alto |  🟠 Medio |
